...
See the [[./slothbar.el]] Package-Requires header for a list of package
...
+ Status bar xcb lifecycle, refresh, and event handling
  Entry point: [[./slothbar.el]]

  This delegates to [[./slothbar-layout.el]] to decide which window areas to
...
+ Logical layout helpers
  Entry point: [[./slothbar-layout.el]]
...
+ Glyph rendering, loading, and compositing
  Entry point: [[./slothbar-render.el]]
...
=slothbar-font-candidates= docstring in [[./slothbar-color.el]].
